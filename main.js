...
(function () {
  ...
  // ============================================================
  // LOCK SCREEN — dipindah PALING ATAS & dibungkus try/catch
  // sendiri, biar keypad-nya PASTI kebentuk apapun yang terjadi
  // di bagian lain. Ini yang paling kritis karena nge-block
  // seluruh halaman kalau gak jalan.
  // ============================================================
  try {
    const lockOverlay = document.getElementById("lockOverlay");
    const lockDots = document.getElementById("lockDots");
    const lockPad = document.getElementById("lockPad");
    const code = String((window.SITE_DATA && SITE_DATA.secretCode) || "0000");
    let entered = "";
    ...
    try {
      document.getElementById("lockHint").textContent =
        SITE_DATA.secretHint || "masukkan kode rahasia kalian";
    } catch (e) {}
  } catch (err) {
    console.error("Lock screen gagal dibuat:", err);
    // fallback darurat: kalau lock screen sendiri gagal total,
    // jangan sampai user terjebak selamanya di layar hitam.
    const lockOverlay = document.getElementById("lockOverlay");
  ...
  try {
    ...
    console.error("Gagal isi konten dari SITE_DATA:", err);
  }
  ...
  try {
    ...
    console.error("Lantern field gagal dibuat:", err);
  }
  ...
  try {
    ...
    console.error("Scroll cue gagal:", err);
  }
  ...
  try {
    ...
    console.error("Gift box gagal:", err);
  }
  ...
  function startTypewriter() {
    try {
      ...
      console.error("Typewriter gagal:", err);
    }
  }
  ...
  try {
    ...
    console.error("Bouquet gagal dibuat:", err);
  }
  ...
  try {
    ...
    console.error("Timeline gagal dibuat:", err);
  }
  ...
  try {
    ...
    console.error("Gallery gagal dibuat:", err);
  }
  ...
  try {
    ...
    console.error("Scroll reveal gagal:", err);
  }
  ...
  try {
    ...
    console.error("Music player gagal:", err);
  }
})();